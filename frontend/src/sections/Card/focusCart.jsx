...
const styles = {
  ...
  card: {
    ...
    alignItems: 'center',
    transition: 'border-color 0.3s ease-in-out',  // Fix typo here
    '&:hover': {
      borderColor: '#CE0101',
    },
  },
  media: {
    height: 100,
    width: 'auto',
    marginBottom: '20px',  // Add margin at the bottom to separate image and text
  },
  mainTypography: {
    fontSize: '22px',
    color:'white',
...
export default function FocusCart() {
  return (
    <>
      <Typography sx={styles.mainTypography}>Our Focus</Typography>
